...
> The preprocessor is responsible for several tasks, including:
  >> Macro substitution: The preprocessor replaces all occurrences of a macro in the code with its corresponding value or expression defined by the programmer.
